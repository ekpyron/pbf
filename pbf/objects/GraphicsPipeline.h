...
public:
    ...
    public:
        ...
        vk::UniquePipeline realize(const vk::Device &device) const;

        void addShaderStage(vk::ShaderStageFlagBits stage, CacheReference<ShaderModule> shader, std::string_view entryPoint) {
